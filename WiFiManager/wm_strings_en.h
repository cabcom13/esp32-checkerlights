...
const char HTTP_HELP[]             PROGMEM =
 ...
 "</table>"
 "<p>Checkerlights made by Sven Schmalfuß</p>"
...
const char S_brand[]              PROGMEM = "Checkerlights Settings";
