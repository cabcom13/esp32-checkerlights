...
int WebOTA::add_http_routes(WebServer *server, const char *path) {
	...
	server->on("/", HTTP_GET, [server]() {
        ...
        ir_html +=  "<div>Name: "+espClientName+"</div>";
		ir_html +=  "<div>SSID: "+wifi_ssid+"</div>";
		ir_html +=  "<div>MQTT: "+mqttserver+"</div>";

        ir_html +=  "<div>TL COMMAND: "+tlcommand+"</div>";
		ir_html +=  "<div>NM COMMAND: "+nmcommand+"</div>";
		ir_html +=  "<br /><br />";
    ...
    server->on("/settings", HTTP_GET, [server,this]() {
        ...
        ir_html += "<label for=\"NMCOMMAND\">TL COMMAND:</label><input type=\"text\" id=\"NMCOMMAND\" value=\""+tlcommand+"\" name=\"TLCOMMAND\"><br><br>";
        ir_html += "<label for=\"TLCOMMAND\">NM COMMAND:</label><input type=\"text\" id=\"TLCOMMAND\" value=\""+nmcommand+"\"  name=\"NMCOMMAND\"><br><br>";
		ir_html += "<input type=\"submit\" value=\"Send\"></form></body></html>";
